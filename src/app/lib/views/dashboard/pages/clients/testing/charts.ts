...
export const chartOptions: Highcharts.Options = {
  ...
  series: [
    {
      data: [
        800, 890, 920, 1022, 789, 2450, 3200, 5200, 1890, 2500, 3200, 3400,
        3500, 5520,
      ],
      type: "line",
    ...
    {
      data: [
        120, 680, 1200, 1100, 850, 960, 1200, 769, 1540, 2100, 3200, 2450, 1850,
        2000,
      ],
      type: "line",
...
// Pie Chart
export const secondOptions: Highcharts.Options = {
  chart: {
